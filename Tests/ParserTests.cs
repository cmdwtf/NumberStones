...
namespace cmdwtf.NumberStones.Tests
{
	...
	public class ParserTests
	{
		...
		[DataRow("8d6cf<=5", "8d6cf<=5")]
		public void DiceParseHandlesOptionCriticalFailure(string input, string expected) => ParseTest(input, expected);

		[DataTestMethod]
		[DataRow("8d6cs>5", "8d6cs>5")]
		[DataRow("8d6cs>=5", "8d6cs>=5")]
		public void DiceParseHandlesOptionCriticalSuccess(string input, string expected) => ParseTest(input, expected);
		...
		public void DiceParseHandlesOptionDrop(string input, string expected) => ParseTest(input, expected);
		...
		public void DiceParseHandlesOptionExplode(string input, string expected) => ParseTest(input, expected);
		...
		public void DiceParseHandlesOptionKeep(string input, string expected) => ParseTest(input, expected);
		...
		public void DiceParseHandlesOptionLabel(string input, string expected) => ParseTest(input, expected);

		[DataTestMethod]
		[DataRow("8d6r2", "8d6r2")]
		[DataRow("8d6r2r4", "8d6r2r4")]
		public void DiceParseHandlesOptionReroll(string input, string expected) => ParseTest(input, expected);

		[DataTestMethod]
		[DataRow("8d6", "8d6")]
		public void DiceParseHandlesOptionTarget(string input, string expected) => ParseTest(input, expected);

		[DataTestMethod]
		[DataRow("8d6t2", "8d6t2")]
		[DataRow("8d6t2t4", "8d6t2t4")]
		public void DiceParseHandlesOptionTwice(string input, string expected) => ParseTest(input, expected);
		...
		public void DiceParseHandlesComplexOptionStrings(string input, string expected) => ParseTest(input, expected);

		private static void ParseTest(string input, string expected)
		{
			DiceExpression? expression = Dice.Parse(input);
			Assert.IsNotNull(expression);
			Assert.IsFalse(expression.IsEmpty);
