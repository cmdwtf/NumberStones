...
namespace cmdwtf.NumberStones.Tests
{
	...
	public class ParserTests
	{
		...
		[DataRow("8d6cf<=5", "8d6cf<=5")]
		public void DiceParseHandlesOptionCriticalFailure(string input, string expected)
		{
		...
		[DataRow("8d6cs>=5", "8d6cs>=5")]
		public void DiceParseHandlesOptionCriticalSuccess(string input, string expected)
		{
			ParseTest(input, expected);
		}
		...
		public void DiceParseHandlesOptionDrop(string input, string expected)
		{
			ParseTest(input, expected);
		}
		...
		public void DiceParseHandlesOptionExplode(string input, string expected)
		{
			ParseTest(input, expected);
		}
		...
		public void DiceParseHandlesOptionLabel(string input, string expected)
		{
			ParseTest(input, expected);
		}
		...
		[DataTestMethod]
		[DataRow("8d6", "8d6")]
		public void DiceParseHandlesOptionTarget(string input, string expected)
		{
			ParseTest(input, expected);
		}
